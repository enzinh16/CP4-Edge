...
def _limpar_relatorio(texto):
    """
    Remove espaços/linhas em branco no início e fim, e reduz
    sequências de 3+ quebras de linha para no máximo 2 (um
    parágrafo em branco), evitando o espaçamento excessivo que
    o LLM às vezes reproduz do template de expected_output.
    """
...
def _gerar_relatorio_sustentacao(alturas, estatisticas):
    ...
    return _limpar_relatorio(str(resultado))
